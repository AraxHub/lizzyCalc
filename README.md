...
- [ ] **feature-env** — конфиг из переменных окружения (порт, хост, строка подключения к БД и т.д.)
- [ ] **feature-architecture** — разделение слоёв: репозиторий (интерфейс), usecase без записи в слайс, чистая архитектура
